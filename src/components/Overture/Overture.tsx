  ...
  return (
    <>
      <div className="overture">
        <Image
          className="overture__image"
          src="/images/assets/1739182509-intro-image.avif"
          alt="Lies Of P - Overture"
          width={1093}
          height={615}
        />
        ...
        <div className="overture__content">
          <div>
            <h1 className="overture__title">Lies of P:</h1>
            <p className="overture__text">Overture</p>
          </div>
          <div className="overture_arrow">
            <span className="overture_arrow_span"></span>
            <svg
              width="54"
              height="28"
              viewBox="0 0 54 28"
      ...
      <div className="overture__trailer">
        <iframe
          src="https://www.youtube.com/embed/-VrjGbwam7o?si=0NfS6L7olKijtBJz"
